...
<body>
  ...
  if (!(empty($_POST))) {
    ...
    $getid=$name=$address=$course=$photo=$username="";
    $checkID = $_POST['edit'];
    ...
    if ($rows=$result->fetch_assoc()) {
      ...
      $getid=$rows['id'];
      $name=$rows['stu_name'];
      $address=$rows['stu_address'];
      $course=$rows['course_type'];
      $photo=$rows['photo'];
      ...
      echo "<h5 class = 'jumbotron text-center'>No students found. Add some students to see their details.</h5>";
    }
  }
    ...
    <div class="cards" style="padding-top:5px;">
      ...
      <form method="post" action="redirect.php">
        ...
        <div class  ="form-group row">
          ...
          <div class="col-sm-10">
            <input required name="username" type="text" class="form-control" id="input4" value="<?php echo $name?>" >
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class  ="form-group row">
          ...
          <div class="col-sm-10">
            <input required name="course" type="text" class="form-control" id="input4" value="<?php echo $course ?>" >
          </div>
        </div>
        <div class="form-group text-center">
          <input type="hidden" name="type" value="student">
          <input type="hidden" name="actionToDo" value="updateStudent">
          <a href="delete.php?id=<?php echo $getid; ?>&name=<?php echo $name;?>"class="btn btn-danger btn-md">Delete</a>
