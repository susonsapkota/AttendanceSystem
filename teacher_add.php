        ...
        <form method="post" action="redirect.php" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="input-group col-sm-10">
              <input name="username" type="text" class="form-control col-sm-10" id="username_input" placeholder="Enter username">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div align="center">
            <input type="hidden" name="actionToDo" value="addTeacher">
